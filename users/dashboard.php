...
<?php include("includes/sidebar.php");?>
      <section id="main-content">
          <section class="wrapper" style="font-family: 'Roboto Mono', monospace; color:black;margin-left:70px;">
  ...
  width: 100%;">
    ...
    <img class="manImg" src="https://icon-library.com/images/document-icon-images/document-icon-images-2.jpg" style="height:70px;width:60px;"></img>
