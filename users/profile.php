...
<html lang="en">
 ...
 ?>                     
  ...
  <h4 class="mb" style="font-size:21px;"><i class="fa fa-user"></i>&nbsp;&nbsp;<?php echo htmlentities($row['fullName']);?>'s Profile</h4>
    <h5><b>Last Updated at :</b>&nbsp;&nbsp;<?php echo htmlentities($row['updationDate']);?></h5><br>
                      <form class="form-horizontal style-form" method="post" name="profile" >

<div class="form-group" style="font-size:17px;">
<label class="col-sm-2 col-sm-2 control-label" style="font-size:17px;">Full Name</label>
<div class="col-sm-4">
...
<div class="form-group" style="font-size:17px;">
<label class="col-sm-2 col-sm-2 control-label">Local Body</label>
<div class="col-sm-4">
